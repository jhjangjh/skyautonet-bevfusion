...
class Cube_Publisher(Node):
    ...
    def publish_boxes(self,bboxes,labels,classes):
        ...
        main_car.header.frame_id = "map"
        main_car.id = 911
        main_car.type = Marker.MESH_RESOURCE
        main_car.action = Marker.ADD
        main_car.mesh_resource = "file:/home/bev/bevfusion/tools/nissan.stl"
...
#=========================================================================
        ...
        # Publish new markers
        # for idx, bbox in enumerate(bboxes.corners):
        ...
        #         marker.type = Marker.CUBE
        #         marker.action = Marker.ADD
        #         marker.pose.position.x = float(bbox[0, 0])
        #         marker.pose.position.y = float(bbox[0, 1])
        #         marker.pose.position.z = float(bbox[0, 2])
        #         marker.scale.x = float(bbox[4, 0] - bbox[0, 0])
        #         marker.scale.y = float(bbox[2, 1] - bbox[0, 1])
