...
#include "custom_msgs/msg/detail/output__rosidl_typesupport_fastrtps_c.h"
...
#include "custom_msgs/msg/detail/bbox__functions.h"  // box
...
using _Output__ros_msg_type = custom_msgs__msg__Output;
  ...
  // Field name: box
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, custom_msgs, msg, Bbox
      )()->data);
...
static uint32_t _Output__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__Output(
...
{
  return max_serialized_size_custom_msgs__msg__Output(
    full_bounded, 0);
}
