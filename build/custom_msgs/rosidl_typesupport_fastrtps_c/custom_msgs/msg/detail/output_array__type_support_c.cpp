...
#include "custom_msgs/msg/detail/output_array__rosidl_typesupport_fastrtps_c.h"
...
#include "custom_msgs/msg/detail/output__functions.h"  // outputs
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_custom_msgs__msg__Output(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_custom_msgs__msg__Output(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, Output)();
...
using _OutputArray__ros_msg_type = custom_msgs__msg__OutputArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: outputs
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, custom_msgs, msg, Output
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: outputs
  {
    ...
    if (ros_message->outputs.data) {
      custom_msgs__msg__Output__Sequence__fini(&ros_message->outputs);
    }
    if (!custom_msgs__msg__Output__Sequence__init(&ros_message->outputs, size)) {
...
size_t get_serialized_size_custom_msgs__msg__OutputArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _OutputArray__ros_msg_type * ros_message = static_cast<const _OutputArray__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name outputs
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_custom_msgs__msg__Output(
...
static uint32_t _OutputArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__OutputArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__msg__OutputArray(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: outputs
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_custom_msgs__msg__Output(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_custom_msgs__msg__OutputArray(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, OutputArray)() {
