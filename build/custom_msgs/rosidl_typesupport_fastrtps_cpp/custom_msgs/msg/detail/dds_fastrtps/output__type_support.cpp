...
#include "custom_msgs/msg/detail/output__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::Output & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::Output & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  // Member: box
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        custom_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Bbox(
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::Output *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::Output *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_Output__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, Output)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_Output__handle;
}
