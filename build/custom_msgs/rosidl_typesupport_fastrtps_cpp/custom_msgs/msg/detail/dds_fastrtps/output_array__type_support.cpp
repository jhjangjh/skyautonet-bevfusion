...
#include "custom_msgs/msg/detail/output_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const custom_msgs::msg::Output &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  custom_msgs::msg::Output &);
size_t get_serialized_size(
  const custom_msgs::msg::Output &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const custom_msgs::msg::OutputArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::OutputArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: outputs
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        custom_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Output(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::OutputArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::OutputArray *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_OutputArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, OutputArray)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_OutputArray__handle;
}
