...
{
  new (message_memory) custom_msgs::msg::OutputArray(_init);
}

void OutputArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msgs::msg::OutputArray *>(message_memory);
  typed_message->~OutputArray();
}

size_t size_function__OutputArray__outputs(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<custom_msgs::msg::Output> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<custom_msgs::msg::Output> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<custom_msgs::msg::Output> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember OutputArray_message_member_array[2] = {
  {
    ...
    offsetof(custom_msgs::msg::OutputArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<custom_msgs::msg::Output>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs::msg::OutputArray, outputs),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers OutputArray_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_msgs::msg::OutputArray),
...
get_message_type_support_handle<custom_msgs::msg::OutputArray>()
{
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::OutputArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msgs, msg, OutputArray)() {
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::OutputArray_message_type_support_handle;
}
