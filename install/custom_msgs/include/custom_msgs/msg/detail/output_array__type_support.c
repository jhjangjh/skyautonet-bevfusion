...
#include <stddef.h>
#include "custom_msgs/msg/detail/output_array__rosidl_typesupport_introspection_c.h"
...
// Member `outputs`
#include "custom_msgs/msg/output.h"
// Member `outputs`
#include "custom_msgs/msg/detail/output__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  custom_msgs__msg__OutputArray__init(message_memory);
}

void OutputArray__rosidl_typesupport_introspection_c__OutputArray_fini_function(void * message_memory)
{
  custom_msgs__msg__OutputArray__fini(message_memory);
}

size_t OutputArray__rosidl_typesupport_introspection_c__size_function__Output__outputs(
  const void * untyped_member)
{
  const custom_msgs__msg__Output__Sequence * member =
    (const custom_msgs__msg__Output__Sequence *)(untyped_member);
  return member->size;
}
...
{
  custom_msgs__msg__Output__Sequence * member =
    (custom_msgs__msg__Output__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  custom_msgs__msg__Output__Sequence * member =
    (custom_msgs__msg__Output__Sequence *)(untyped_member);
  custom_msgs__msg__Output__Sequence__fini(member);
  return custom_msgs__msg__Output__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember OutputArray__rosidl_typesupport_introspection_c__OutputArray_message_member_array[2] = {
  {
    ...
    offsetof(custom_msgs__msg__OutputArray, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs__msg__OutputArray, outputs),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers OutputArray__rosidl_typesupport_introspection_c__OutputArray_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_msgs__msg__OutputArray),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_msgs, msg, OutputArray)() {
